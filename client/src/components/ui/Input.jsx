      ...
      <div className="relative group">
        ...
        {isPassword && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-indigo-500 dark:hover:text-violet-400 transition-colors focus:outline-none"
          >
